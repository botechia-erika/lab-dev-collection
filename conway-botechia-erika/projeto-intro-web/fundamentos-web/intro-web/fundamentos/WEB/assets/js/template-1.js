let partial00A = `
    <nav class="menu" id="idMenu">
      ...
      <ul class="menu__item ">
        <li class="item"><a href="#" class="link-item">Home</a></li>
        <li class="item"><a href="/FUNDAMENTOS-WEB" class="link-item">Cursos</a></li>
        <li class="item"><a href="/FUNDAMENTOS-HTML" class="link-item">COPA DEV</a></li>
        <li class="item"><a href="/FUNDAMETOS-JS" class="link-item">Contacto</a></li>
        <li class="item"><a href="/FUNDAMENTOS-CSS" class="link-item">Matriculas</a>
        </li>
        <li class="item"><a href="/JWS-AUTH" class="link-item">Login</a></li>
      </ul>
